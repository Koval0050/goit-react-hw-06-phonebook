...
export const App = () => {
  ...
  //завантажуємо контакти якщо такі є
  useEffect(() => {
  ...
  const handleAddContact = newContactData => {
    ...
    checkNewContactPresence(newContactEntity.name)
      ? alert(`${newContactEntity.name} is already in contacts!`)
      : setContacts(prev => [...prev, newContactEntity]);
    save('contacts', contacts); // This line might be unnecessary
  };
